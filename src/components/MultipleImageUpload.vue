<template>
  <div
      ...
      @drop="preventEvent"
      class="photoUploadAndCamera"
  >
    <div class="camera-button" v-if="camera">
      <button type="button" class="button is-rounded cam-button" style="margin-left: 40%; background-color: white; border: 0px;"
              :class="{ 'is-primary' : !isCameraOpen, 'is-danger' : isCameraOpen}" @click="toggleCamera" :disabled='isCameraDisabled'>
    ...
    <div v-if="isCameraOpen" class="camera-shoot">
      <img style="height: 25px;" src="https://img.icons8.com/material-outlined/50/000000/camera--v2.png" class="button-img"
           @click="takePhoto"/>
    </div>
    <div v-if="isCameraOpen" class="camera-box" :class="{ 'flash' : isShotPhoto }" style="">
      <div class="camera-shutter" :class="{'flash' : isShotPhoto}"></div>
      <video ref="camera" :width="videoWidth" :height="videoHeight" autoplay></video>
      ...
      >
        ...
        >
          <div>
            ...
            >
              <path
                  d="M383.6 229l-.5 1.5.7 1.7c-.2-1.1-.2-2.2-.2-3.2zm-119.7-5.4l-.3 1.4.6 1.3c-.2-.8-.3-1.8-.3-2.7zm62.4 3.8l-.2 1 .5 1.1-.3-2.1z"></path>
              <path
          ...
          <div class="text-center" v-if="browseText || dragText">
        ...
        >
          ...
          >
            ...
            <div class="image-overlay-details full-width">
              ...
              >
                <path
                    d="M283.9 186.4h-64.6l-.4-71.1c-.1-8.8-7.2-15.9-16-15.9h-.1c-8.8.1-16 7.3-15.9 16.1l.4 70.9h-64.4c-8.8 0-16 7.2-16 16s7.2 16 16 16h64.6l.4 71.1c.1 8.8 7.2 15.9 16 15.9h.1c8.8-.1 16-7.3 15.9-16.1l-.4-70.9h64.4c8.8 0 16-7.2 16-16s-7.1-16-16-16z"></path>
                <path
          ...
          >
            ...
            >
              <div
                  ...
                  v-show="imageDefault"
              >
              <span class="image-primary display-flex align-items-center" v-if="primaryText">
                <svg
            ...
            <div class="display-flex">
              ...
              >
                ...
                >
                  <path
                      d="M448 64h-96V0H159.9l.066 64H32v32h32v416h384V96h32V64h-32zM192 32h128v32H192V32zm224 448H96V96h320v384zM192 160h32v256h-32V160zm96 0h32v256h-32V160z"></path>
                </svg>
              </a>
            </div>
          </div>
  ...
  methods: {
    ...
    createImage(file) {
      ...
      reader.onload = (e) => {
        ...
        if (dataURI) {
          this.setImagesData(file, dataURI)
        }
      }
      reader.readAsDataURL(file)
    },
    setImagesData(file, dataURI) {
      ...
      this.$emit('upload-success', file, this.images.length - 1, this.images)
    },
    editImage(file) {
      if (this.disabled) return
      let reader = new FileReader()
      ...
      reader.readAsDataURL(file)
      this.$emit('edit-image', file, this.currentIndexImage, this.images)
    },
    uploadFieldChange(e) {
    ...
    isValidNumberOfImages(amount) {
      let totalImageUploadSize = amount + this.images.length
      if (totalImageUploadSize > this.maxImage) {
    ...
    enableDisableCamera(){
      if (!this.multiple || this.isLimitExceed()){
        this.disableCamera()
      }else {
        this.enableCamera();
      }
